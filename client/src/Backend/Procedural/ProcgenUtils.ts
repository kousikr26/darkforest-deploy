...
export class ProcgenUtils {
  ...
  private static baseByBiome: { readonly [Biome: number]: HSLVec } = {
    [Biome.UNKNOWN]: [0, 0, 0],
    [Biome.OCEAN]: [215, 100, 34],
    [Biome.FOREST]: [102, 78, 83],
    [Biome.GRASSLAND]: [155, 94, 70],
    [Biome.TUNDRA]: [326, 100, 78],
    [Biome.SWAMP]: [46, 78, 34],
    [Biome.DESERT]: [53, 75, 58],
    [Biome.ICE]: [202, 88, 75],
    [Biome.WASTELAND]: [0, 0, 18],
    [Biome.LAVA]: [356, 64, 52],
    [Biome.CORRUPTED]: [100, 80, 54],
  } as const;
  private static oceanByBiome: { readonly [Biome: number]: HSLVec } = {
    [Biome.UNKNOWN]: [0, 0, 0],
    [Biome.OCEAN]: [209, 52, 63],
    [Biome.FOREST]: [216, 96, 43],
    [Biome.GRASSLAND]: [195, 100, 46],
    [Biome.TUNDRA]: [212, 95, 70],
    [Biome.SWAMP]: [265, 47, 73],
    [Biome.DESERT]: [31, 100, 50],
    [Biome.ICE]: [202, 100, 83],
    [Biome.WASTELAND]: [210, 53, 64],
    [Biome.LAVA]: [12, 92, 39],
