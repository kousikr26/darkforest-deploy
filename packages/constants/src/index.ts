 ...
 */
export const GAS_PRICE_API = '' as const;
 ...
 * money.
 */
export const MAX_AUTO_GAS_PRICE_GWEI = 500 as const;
...
export const BLOCK_EXPLORER_URL = 'https://explorer.harmony.one/' as const;
