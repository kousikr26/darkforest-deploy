...
export class TxExecutor {
  ...
  public queueTransaction(
    ...
    this.queue.add(() => {
      ...
      console.log("Gas", txRequest.overrides.gasPrice);
  ...
  private execute = async (txRequest: QueuedTransaction) => {
    ...
    console.log("Execute: Inside function");
    try {
      console.log("Execute: Inside try");
